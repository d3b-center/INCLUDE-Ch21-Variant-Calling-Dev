...
def get_contig_list(vcf_file: str) -> list[str]:
    ...
    contig_list = tbx.contigs
    return contig_list


def print_contig_record(in_vcf: VariantFile, contig: str):
    """
...
def main():
    parser = argparse.ArgumentParser(description="Merge VCFs and rename sample name in coordinate sorted VCFs.")
    ...
    with VariantFile(args.first_vcf, threads=8) as vcf1, VariantFile(args.second_vcf, threads=8) as vcf2:
